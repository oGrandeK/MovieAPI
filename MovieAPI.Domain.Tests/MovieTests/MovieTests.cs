...
public class MovieTests
{
    ...
    public void ShouldReturnDomainExceptionValidationWhenMovieTitleHasLessThan2CharacterLong() {
        ...
        {
            var movie = new Movie(new Title("T"), 1, null, null, null, null, null);
        });
    }
    ...
    public void ShouldReturnDomainExceptionValidationWhenMovieTitleHasMoreThan50CharactersLong() {
        Assert.ThrowsException<DomainExceptionValidation>(() =>
        {
            var movie = new Movie(new Title("AaaaaaaaaaaaaaaaaaaaaAaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"), 1, null, null, null, null, null);
        });
    }
    ...
    public void ShouldReturnDomainExceptionValidationWhenMovieTitleIsEmpty() {
        Assert.ThrowsException<DomainExceptionValidation>(() =>
        {
            var movie = new Movie(new Title(""), 1, null, null, null, null, null);
        });
    }
    ...
    public void ShouldReturnDomainExceptionValidationWhenMovieTitleHasSpecialCharacter() {
        Assert.ThrowsException<DomainExceptionValidation>(() => 
        {
            var movie = new Movie(new Title("T@y St@ry"), 1, null, null, null, null, null);
        });
    }
    ...
    public void ShouldReturnDomainExceptionValidationWhenMovieDescriptionHasLessThan10Characters() {
        Assert.ThrowsException<DomainExceptionValidation>(() => 
        {
            var movie = new Movie(new Title("Toy Story"), 1, "An Am", null, null, null, null);
        });
    }
    ...
    public void ShouldReturnDomainExceptionValidationWhenMovieGenreDoesntExist() {
        Assert.ThrowsException<DomainExceptionValidation>(() => 
        {
            var movie = new Movie(new Title("Toy Story"), 1, "An amazing movie to watch with your family", (GenreEnumerator)7, null, null, null);
        });
    }
    ...
    public void ShouldReturnDomainExceptionValidationWhenMovieDurationHasLessThan0Minutes() {
        Assert.ThrowsException<DomainExceptionValidation>(() => 
        {
            var movie = new Movie(new Title("Toy Story"), 1, "An amazing movie to watch with your family", GenreEnumerator.Comedy, -1, null, null);
        });
    }
    ...
    public void ShouldReturnDomainExceptionValidationWhenMovieDurationHasMoreThan600Minutes() {
        Assert.ThrowsException<DomainExceptionValidation>(() => 
        {
           var movie = new Movie(new Title("Toy Story"), 1, "An amazing movie to watch with your family", GenreEnumerator.Comedy, 601, null, null); 
        });
    }
    ...
    public void ShouldReturnDomainExceptionValidationWhenMovieReleaseDateAreInferiorThan19851228() {
        Assert.ThrowsException<DomainExceptionValidation>(() => 
        {
            var movie = new Movie(new Title("Toy Story"), 1, "An amazing movie to watch with your family", GenreEnumerator.Comedy, 120, new DateTime(1984, 12, 28), null);
        });
    }
    ...
    public void ShouldReturnDomainExceptionValidationWhenMovieRatingHasLessThan0() {
        Assert.ThrowsException<DomainExceptionValidation>(() => 
        {
            var movie = new Movie(new Title("Toy Story"), 1, "An amazing movie to watch with your family", GenreEnumerator.Comedy, 120, new DateTime(2019, 05, 15), -1);
        });
    }
}